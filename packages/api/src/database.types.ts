// Generated by `supabase gen types typescript` (via Supabase MCP) — Phase 02.
    ...
    Tables: {
      ...
      booking_confirmations: {
        Row: {
          ...
          id: string
          interpreter_contact_shared: string
          interpreter_id: string
          signer_contact_shared: string
        }
        Insert: {
          booking_id: string
          confirmed_at?: string | null
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "booking_confirmations_interpreter_id_fkey"
      ...
      booking_interests: {
        ...
        Relationships: [
          {
            foreignKeyName: "booking_interests_booking_id_fkey"
            columns: ["booking_id"]
            isOneToOne: false
            referencedRelation: "bookings"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "booking_interests_interpreter_id_fkey"
            columns: ["interpreter_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      bookings: {
        ...
        Relationships: [
          {
            foreignKeyName: "bookings_signer_id_fkey"
            columns: ["signer_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
